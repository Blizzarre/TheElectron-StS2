...
public class Reroute : ElectronDepleteCard
{
    ...
    public Reroute() : base(2, CardType.Skill, CardRarity.Uncommon, TargetType.Self)
    {
        WithKeyword(ElectronKeywords.Drain);
        WithVars(new FaradVar(5).WithUpgrade(1), new FaradVar(DepleteFaradKey, 2).WithUpgrade(1));
